'use strict';Object.defineProperty(exports,'__esModule',{value:true});function _interopDefault(e){return(e&&(typeof e==='object')&&'default'in e)?e['default']:e}var inquirer=require('inquirer'),datastore=_interopDefault(require('nedb')),path=require('path'),Table=_interopDefault(require('cli-table')),os=_interopDefault(require('os')),ora=_interopDefault(require('ora'));/*! *****************************************************************************
...
var colorConvert = convert;var ansiStyles = createCommonjsModule(function (module) {
...
var chalk_1 = chalk.supportsColor;var table = new Table({
...
}exports.add=addTemplate;exports.del=deleteTemplate;exports.init=initTemplate;exports.list=listTemplates;